    ...
    return (
        <section className="w-full px-4 md:px-10 lg:px-20">
            ...
            <section className="mt-10 flex flex-col lg:flex-row items-center gap-10">
                ...
                {/* Text */}
                <div className="text-white/80 text-base md:text-lg leading-relaxed max-w-2xl">
                    <p>
                        I&apos;m a software engineer who is currently focused on growing in the
                              Machine Learning direction, while building strong foundations in
                              full-stack development. At this stage of my career, my main strength is
                              curiosity — I genuinely enjoy learning new technologies, exploring how
                              things work under the hood, and quickly adapting to new tools, teams,
                              and environments.
                        <br/><br/>
